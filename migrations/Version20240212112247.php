 ...
 */
final class Version20240212112247 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE producto (id INT AUTO_INCREMENT NOT NULL, nombre VARCHAR(45) NOT NULL, descripcion VARCHAR(255) NOT NULL, peso DOUBLE PRECISION NOT NULL, stock INT NOT NULL, imagen VARCHAR(255) NOT NULL, categoria_id INT NOT NULL, INDEX IDX_A7BB06153397707A (categoria_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE restaurante (id INT AUTO_INCREMENT NOT NULL, correo VARCHAR(90) NOT NULL, clave VARCHAR(45) NOT NULL, pais VARCHAR(45) NOT NULL, cp INT NOT NULL, ciudad VARCHAR(45) NOT NULL, direccion VARCHAR(255) NOT NULL, rol VARCHAR(45) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
